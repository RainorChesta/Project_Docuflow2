...
file_put_contents(__DIR__ . '/patch_print_f4.py', $pythonScript);
exec('docker cp ' . escapeshellarg(__DIR__ . '/patch_print_f4.py') . ' dokuflow-onlyoffice:/tmp/patch_print_f4.py');
$out = shell_exec('docker exec dokuflow-onlyoffice python3 /tmp/patch_print_f4.py');
echo $out . PHP_EOL;
