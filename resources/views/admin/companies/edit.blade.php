            ...
            <div class="card bg-base-100 border border-base-300 shadow-sm p-4 sm:p-6">
                <form method="POST" action="{{ route('admin.companies.update', $company) }}">
                    ...
                    <div class="form-control w-full mb-4">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $company->name) }}" class="input input-bordered w-full uppercase" oninput="this.value = this.value.toUpperCase()" required>
                    </div>
