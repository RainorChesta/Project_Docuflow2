<x-app-layout>
    <x-slot name="header">{{ __('Tambah Unit Kerja Baru') }}</x-slot>
            ...
            <div class="card bg-base-100 border border-base-300 shadow-sm p-4 sm:p-6">
                <form method="POST" action="{{ route('admin.unit-kerja.store') }}">
                    ...
                    <div x-data="{
                        ...
                        selectedCabangId: '{{ old('cabang_id', $selectedCabangId ?? '') }}',
                        ...
                        <div class="form-control w-full mb-4">
                            ...
                            <input type="text" name="kode_unit_kerja" id="kode_unit_kerja" value="{{ old('kode_unit_kerja') }}" placeholder="Contoh: 11" class="input input-bordered w-full uppercase font-mono" maxlength="50" required>
                        ...
                        <div class="form-control w-full mb-6">
                            ...
                            <input type="text" name="nama_unit_kerja" id="nama_unit_kerja" value="{{ old('nama_unit_kerja') }}" placeholder="Contoh: Unit Operasional & Layanan" class="input input-bordered w-full" required>
                    ...
                    <div class="flex flex-wrap items-center justify-end gap-2 pt-2 border-t border-base-200">
                        <a href="{{ route('admin.unit-kerja.index') }}" class="btn btn-ghost">{{ __('Batal') }}</a>
