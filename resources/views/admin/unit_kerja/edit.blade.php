    ...
    <div class="py-6">
        <div class="max-w-xl mx-auto w-full px-0">
            <div class="card bg-base-100 border border-base-300 shadow-sm p-4 sm:p-6"
                 x-data="{
                     kode: '{{ old('kode_unit_kerja', $unitKerja->kode_unit_kerja) }}',
                     nama: '{{ old('nama_unit_kerja', $unitKerja->nama_unit_kerja) }}',
                     get previewCode() {
                ...
                <div class="mb-5 pb-4 border-b border-base-200">
                    <h2 class="text-lg font-bold text-base-content">{{ __('Edit Master Unit Kerja') }}</h2>
                ...
                <form method="POST" action="{{ route('admin.unit-kerja.update', $unitKerja) }}">
                    ...
                    <div class="form-control w-full mb-5">
                        ...
                        <div x-data="{
                            search: '',
                            open: false,
                            value: '{{ old('pic_user_id', $unitKerja->pic_user_id ?? '') }}',
                            options: [
