                        ...
                        <tbody>
                            @forelse($categories as $category)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('admin.template-categories.edit', $category) }}" class="btn btn-ghost btn-xs btn-square text-primary" title="Edit">
                                        ...
                                        <form method="POST" action="{{ route('admin.template-categories.destroy', $category) }}" class="inline" onsubmit="return confirm('Hapus kategori ini?')">
                                            @csrf @method('DELETE')
                                            <button class="btn btn-ghost btn-xs btn-square text-error ml-1" title="Hapus">
