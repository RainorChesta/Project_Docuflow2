<form method="GET" action="{{ route('documents.index') }}" class="mb-4 flex flex-wrap gap-2 items-center w-full">
    ...
    <div class="flex gap-2 items-center ml-auto shrink-0 w-full sm:w-auto mt-2 sm:mt-0 justify-end">
        ...
        <div class="divider divider-horizontal hidden xl:flex m-0"></div>
