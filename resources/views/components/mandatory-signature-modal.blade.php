        ...
        <div class="card bg-base-100 max-w-md w-full shadow-2xl border border-warning/30">
            <div class="card-body text-center items-center py-8 px-6 space-y-4">
                ...
                <p class="text-sm text-base-content/70 leading-relaxed">
                    Sesuai keamanan dan kebijakan sistem DokuFlow, Anda <strong>wajib membuat dan menyimpan tanda tangan digital (TTD)</strong> pada profil akun Anda terlebih dahulu sebelum dapat mengakses atau mengelola fitur dokumen lainnya.
                </p>
