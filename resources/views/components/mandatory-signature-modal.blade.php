@if((!app()->environment('testing') || request()->header('X-Test-Enforce-Signature')) && auth()->check() && !auth()->user()->hasSignature('original') && !request()->routeIs(['profile.edit', 'profile.update', 'profile.signature.*']))
