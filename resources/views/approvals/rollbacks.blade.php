<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            @if(($counts['rollbacks'] ?? $pendingRollbacks->total()) > 0)
            <div class="flex items-center gap-2 shrink-0">
                <span class="badge badge-secondary font-bold text-white gap-1.5 text-xs py-2.5 px-3 font-semibold shadow-xs">
