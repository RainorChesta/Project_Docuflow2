    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="bg-base-100 border border-base-300 rounded-box">
            <div class="px-5 py-4 border-b border-base-300 flex items-center justify-between">
                ...
                <a href="{{ route('documents.index') }}" class="text-sm font-medium text-primary hover:text-primary/80 transition-colors">View all</a>
            </div>
            <div class="divide-y divide-base-200">
                @forelse(auth()->user()->documents()->latest()->take(5)->get() as $doc)
