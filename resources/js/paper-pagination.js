...
export const DEFAULT_MARGIN = { top: 96, right: 96, bottom: 96, left: 96 };
export const MIN_PAGE_CONTENT_PX = 60;
export const BOUNDARY_EPS = 0.5;

export function findPaperKey(size) {
...
export function clampMarginToPage(size, margin) {
...
export function buildSpacerElement(margin, gap, extraAttrs) {
...
export function mergeSplitLists(container) {
...
export function paginateList(list, containerTop, paddingTop, contentPerPage, gap, margin, startBoundary) {
...
export function paginateContainer(container, contentPerPage, gap, margin) {
...
// Global window registration for compatibility
